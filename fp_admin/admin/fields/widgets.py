...
def validate_widget_combination(field_type: FieldType, widget: WidgetType) -> bool:
    """Validate that widget is compatible with field type."""
    valid_widgets = VALID_WIDGET_COMBINATIONS.get(field_type, [])
    return widget in valid_widgets
